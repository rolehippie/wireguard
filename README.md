...
[![Readme Workflow](https://github.com/rolehippie/wireguard/actions/workflows/docs.yml/badge.svg)](https://github.com/rolehippie/wireguard/actions/workflows/docs.yml)
...
wireguard_packages:
  ...
  - wireguard-tools
  - wireguard
  - "{{ 'wireguard-dkms' if ansible_facts['distribution_version'] is version('24.04', '<') else omit }}"
```
